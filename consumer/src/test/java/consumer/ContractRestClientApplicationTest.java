...
public class ContractRestClientApplicationTest {
	...
	public StubRunnerRule stubRunnerRule = new StubRunnerRule()
		.downloadStub("de.bguenthe", "producer", "1.0-SNAPSHOT", "stubs")
		.withPort(8100)
	...
	public void get_person_from_service_contract() {
		...
		// when:
		ResponseEntity<String> personResponseEntity = restTemplate.getForEntity("http://localhost:8100/ottomarketstock", String.class);
